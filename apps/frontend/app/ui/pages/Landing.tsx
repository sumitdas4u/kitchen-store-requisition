      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {userTypes.map((type) => (
            ...
            >
              <div
                className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${type.color} rounded-2xl mb-6 group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 text-center">
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600">
              Large touch controls for quick operations
            </p>
          </div>
          <div className="p-6">
            <div className="text-3xl mb-2">ERP</div>
            <h3 className="text-gray-900 mb-1">ERP Integrated</h3>
            <p className="text-sm text-gray-600">
              Seamless sync with ERPNext
            </p>
          </div>
          <div className="p-6">
            <div className="text-3xl mb-2">PWA</div>
